About cargo-auditable-feedstock
===============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cargo-auditable-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cargo-auditable-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add cargo-auditable
# for installing globally
pixi global install cargo-auditable
```
...
It is possible to list all of the versions of `cargo-auditable` available on your platform:
...
```
pixi search cargo-auditable --channel conda-forge
```
